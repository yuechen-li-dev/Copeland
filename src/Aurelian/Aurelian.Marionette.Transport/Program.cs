...
internal static class Program
{
    ...
    {
        if (args.Length != 3 || (args[0] != "loopback" && args[0] != "scenario") || args[1] != "--config")
        {
            Console.Error.WriteLine("Usage: Aurelian.Marionette.Transport <loopback|scenario> --config <ignored-local-config.json>");
            return 2;
        }
