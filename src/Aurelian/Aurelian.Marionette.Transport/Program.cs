...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        {
            Console.Error.WriteLine("Usage: Aurelian.Marionette.Transport <loopback|scenario|session-bootstrap|eligible-host-fixtures|disconnect-restoration|dominatus-skyrim|live-save-correlation> --config <ignored-local-config.json>");
            return 2;
        }
