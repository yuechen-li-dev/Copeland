...
public sealed record CardTextLayout(
    double LineHeight,
    double LineGap,
    string? Prefix = null);
...
public static class CardLayoutHelper
{
    ...
    public static int ComputeLineCapacity(CardLayout layout, CardTextLayout textLayout)
    {
    ...
    public static int ComputeLineCapacity(double availableHeight, CardTextLayout textLayout)
    {
        ArgumentNullException.ThrowIfNull(textLayout);
