...
public sealed class SilkInputBridge : IDisposable
{
    ...
    private static bool TryMapKey(SilkKey key, out KeyboardKey mapped)
    {
        mapped = key switch
        {
            ...
            SilkKey.F1 => KeyboardKey.F1,
            SilkKey.F2 => KeyboardKey.F2,
            SilkKey.F3 => KeyboardKey.F3,
            SilkKey.F4 => KeyboardKey.F4,
            SilkKey.F5 => KeyboardKey.F5,
            SilkKey.F6 => KeyboardKey.F6,
            SilkKey.F7 => KeyboardKey.F7,
            SilkKey.F8 => KeyboardKey.F8,
            SilkKey.F9 => KeyboardKey.F9,
            SilkKey.F10 => KeyboardKey.F10,
            SilkKey.F11 => KeyboardKey.F11,
            SilkKey.F12 => KeyboardKey.F12,
