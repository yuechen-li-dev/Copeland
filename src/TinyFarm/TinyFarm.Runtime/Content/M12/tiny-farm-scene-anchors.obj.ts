const $schema: string = "copeland://tiny-farm/content/m12/anchors";
...
record table SceneAnchors {
    anchorId: string = [
        ...
        "residence.from-farm", "elias.home-bed", "mara.home-bed", "sela.home-bed"
    ];
    sceneId: string = [
    ...
    x: number = [3, 10, 18, 16, 6, 4, 6, 10, 16, 12, 5, 5, 2, 5, 9, 2, 6, 10];
    y: number = [7, 5, 9, 6, 5, 7, 5, 12, 4, 7, 6, 3, 5, 5, 7, 2, 2, 2];
    kind: string = [
        "Spawn", "Spawn", "Spawn", "Spawn", "Spawn", "Home", "Work",
        "Spawn", "Spawn", "Social", "Spawn", "ShopCounter", "Spawn", "Social",
        "Spawn", "Rest", "Rest", "Rest"
    ];
    semanticLocation: OptionalText = [
        ...
        OptionalText.Some("farmhouse"), OptionalText.Some("farmhouse"), OptionalText.Some("farmhouse"), OptionalText.Some("farmhouse")
    ];
    semanticObject: OptionalText = [
        ...
        OptionalText.None, OptionalText.Some("elias-bed"), OptionalText.Some("mara-bed"), OptionalText.Some("sela-bed")
    ];
    facing: OptionalText = [
        OptionalText.None, OptionalText.None, OptionalText.None, OptionalText.None,
        OptionalText.None, OptionalText.None, OptionalText.None, OptionalText.None,
        OptionalText.None, OptionalText.None, OptionalText.None, OptionalText.None,
        OptionalText.None, OptionalText.None,
        OptionalText.None, OptionalText.Some("Up"), OptionalText.Some("Up"), OptionalText.Some("Up")
    ];
    arrivalRadiusUnits: number = [128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 768, 768, 768];
}
