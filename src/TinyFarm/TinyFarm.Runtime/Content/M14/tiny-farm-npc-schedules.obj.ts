const $schema: string = "copeland://tiny-farm/content/m14/npc-schedules";
...
record table NpcSchedules {
    ...
    regime: ScheduleRegime = [
        ...
        ScheduleRegime.Open, ScheduleRegime.Required, ScheduleRegime.Open, ScheduleRegime.Required,
    ...
    reason: string = [
        ...
        "daily-morning-wander", "daily-afternoon-riverside", "daily-evening-open", "daily-bedtime",
