...
record table SceneAnchors {
    ...
    x: number = [3, 10, 18, 16, 6, 4, 6, 5, 10, 10, 16, 12, 5, 5, 2, 5, 9, 2, 6, 10];
    y: number = [7, 5, 9, 6, 5, 7, 5, 8, 9, 12, 4, 7, 6, 3, 5, 5, 7, 2, 2, 2];
    kind: string = [
    ...
    arrivalRadiusUnits: number = [128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 768, 768, 768];
}
