...
internal sealed class CopelandWorkspace
{
    ...
    public object? Completion(string uri, JsonElement position)
    {
        ...
        foreach (string keyword in new[] { "function", "template", "instantiate", "static", "reflect", "type", "record", "layout", "layers", "stream", "state", "on", "effect", "after", "StateCommitted", "PresentationCommitted", "AttachmentsSettled", "satisfies", "bind", "csv", "row", "column", "grid", "anchor", "overlay", "slot", "with", "width", "height", "gap", "padding", "layer", "z", "overflow", "visible", "clip", "auto", "scroll", "scrollX", "scrollY", "fontSize", "minFontSize", "lines", "wrap", "textFit", "scaleDown", "textFallback", "ellipsis", "fill", "fit", "enum", "match", "switch", "return", "const", "let", "using", "import", "export", "async", "remote", "fieldsOf", "nameOf", "enumCasesOf", "callsOf", "Diagram", "diagram", "diagramNode", "diagramEdge", "recordDiagram", "enumDiagram", "callGraphDiagram", "DotNetSolution", "DotNetProject", "TypeScriptWorkspace", "NpmPackageManifest", "NpmDependency", "CopelandSourceSet", "CopelandProjectTypeSet", "ProjectFile", "Text", "Document", "Heading", "Paragraph", "List", "Item", "CodeBlock", "Quote", "Callout", "Break", "HeroHeading", "SectionHeading", "CardHeading", "Body", "Eyebrow", "Caption" })
        {
