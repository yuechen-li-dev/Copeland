...
namespace Typography.OpenFont
{
    ...
    public class Glyph
    {
        ...
        //TrueTypeFont
        public ushort[] EndPoints { get; private set; }         //NULL in layout-essential clones
        public GlyphPointF[] GlyphPoints { get; private set; }  //NULL in layout-essential clones
        internal byte[] GlyphInstructions { get; set; }         //NULL in layout-essential clones
        ...
        internal readonly CFF.Cff1GlyphData _cff1GlyphData;             //NULL in layout-essential clones
