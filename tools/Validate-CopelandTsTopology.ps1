...
foreach ($fixture in $copeFixtures) {
    Require-Condition ($fixture.Directory.Name -match 'mir|cts-union-m0b|cts-call-m0b|cts-call-m1') ".cope fixture is not owned by a MIR corpus case: $($fixture.FullName)"
}
