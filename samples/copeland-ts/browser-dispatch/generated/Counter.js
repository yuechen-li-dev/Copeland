...
function __cope_record_0072003200300035003600390035003000300031(field0) {
    return __cope_m3_record_make_r205695001_4(field0);
}

const __cope_m3_type_7 = Object.freeze(Object.create(null));
const __cope_m3_instances_8 = new WeakSet();

function __cope_enum_0043006f0075006e007400650072004500760065006e0074_0049006e006300720065006d0065006e0074() {
    return __cope_m3_make_1(__cope_m3_type_7, "Increment", []);
}

function __cope_enum_0043006f0075006e007400650072004500760065006e0074_00520065007300650074() {
    return __cope_m3_make_1(__cope_m3_type_7, "Reset", []);
}
...
function Reduce(state, event) {
    const __cope_m3_match_10 = event;
    __cope_m3_validate_9(__cope_m3_match_10);
    let __cope_m3_match_value_11;
    switch (__cope_m3_match_10.$tag) {
        case "Increment":
        {
            const __cope_m3_record_source_12 = state;
            __cope_m3_record_require_r205695001_5(__cope_m3_record_source_12);
            const __cope_m3_record_receiver_13 = state;
            __cope_m3_record_require_r205695001_5(__cope_m3_record_receiver_13);
            const __cope_m3_record_replacement_14 = (__cope_m3_record_receiver_13[__cope_m3_record_field___cope_0072003200300035003600390035003000300031002e00660030_6] + 1);
            __cope_m3_match_value_11 = __cope_record_0072003200300035003600390035003000300031(__cope_m3_record_replacement_14);
            break;
        }
        case "Reset":
        {
            const __cope_m3_record_source_15 = state;
            __cope_m3_record_require_r205695001_5(__cope_m3_record_source_15);
            const __cope_m3_record_replacement_16 = 0;
            __cope_m3_match_value_11 = __cope_record_0072003200300035003600390035003000300031(__cope_m3_record_replacement_16);
            break;
        }
        default:
            __cope_m3_panic_0();
    }
    return __cope_m3_match_value_11;
}

function SendIncrement(send) {
    __cope_callable_invoke(send, "(named:CounterEvent)->named:void", [__cope_enum_0043006f0075006e007400650072004500760065006e0074_0049006e006300720065006d0065006e0074()]);
}

function SendReset(send) {
    __cope_callable_invoke(send, "(named:CounterEvent)->named:void", [__cope_enum_0043006f0075006e007400650072004500760065006e0074_00520065007300650074()]);
}
export { Reduce, SendIncrement, SendReset };
export { __cope_enum_0043006f0075006e007400650072004500760065006e0074_0049006e006300720065006d0065006e0074, __cope_enum_0043006f0075006e007400650072004500760065006e0074_00520065007300650074, __cope_record_0072003200300035003600390035003000300031 };
