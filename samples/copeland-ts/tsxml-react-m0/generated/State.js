...
function __cope_record_0072003100340037003600300034003000300031(field0) {
    return __cope_m3_record_make_r147604001_4(field0);
}

const __cope_m3_type_7 = Symbol("AppEvent");
const __cope_m3_type_7_case_0 = Object.freeze({ $type: __cope_m3_type_7, $tag: "Increment" });

function __cope_enum_004100700070004500760065006e0074_0049006e006300720065006d0065006e0074() {
    return __cope_m3_type_7_case_0;
}
...
function InitialState() {
    const __cope_m3_record_init_10 = 0;
    return __cope_record_0072003100340037003600300034003000300031(__cope_m3_record_init_10);
}

function Reduce(state, event) {
    if (!((__cope_m3_record_require_r147604001_5(state), true))) { __cope_m3_panic_0(); }
    if (!((__cope_m3_validate_9(event), true))) { __cope_m3_panic_0(); }
    const __cope_m3_match_11 = event;
    let __cope_m3_match_value_12;
    switch (__cope_m3_match_11.$tag) {
        case "Increment":
        {
            const __cope_m3_record_source_13 = state;
            const __cope_m3_record_receiver_14 = state;
            const __cope_m3_record_replacement_15 = (__cope_m3_record_receiver_14.$f0 + 1);
            __cope_m3_match_value_12 = __cope_record_0072003100340037003600300034003000300031(__cope_m3_record_replacement_15);
            break;
        }
        default:
            __cope_m3_panic_0();
    }
    return __cope_m3_match_value_12;
}
export { InitialState, Reduce };
export { __cope_enum_004100700070004500760065006e0074_0049006e006300720065006d0065006e0074, __cope_record_0072003100340037003600300034003000300031 };
