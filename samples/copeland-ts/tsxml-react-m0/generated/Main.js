...
function __cope_Main_ts___cope_arrow_0(root, state, send) {
    return root.render(View(state, send));
}

function Main() {
    const root = createRoot(getMountElement("app"));
    __cope_callable_host("(named:AppEvent)->named:void", dispatchReact(InitialState(), (...args) => __cope_callable_invoke(__cope_callable_ref("(record:r147604001,named:AppEvent)->record:r147604001", Reduce), "(record:r147604001,named:AppEvent)->record:r147604001", [args[0], args[1]]), (...args) => __cope_callable_invoke(__cope_callable_capture("(record:r147604001,(named:AppEvent)->named:void)->named:void", __cope_Main_ts___cope_arrow_0, [root]), "(record:r147604001,(named:AppEvent)->named:void)->named:void", [args[0], __cope_callable_host_retained("(named:AppEvent)->named:void", args[1])])));
}
export { Main };
