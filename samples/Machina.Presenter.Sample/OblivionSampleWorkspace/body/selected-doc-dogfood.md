...
This card is a curated dogfood slice of `docs/copeland-markdown-frontend-m12a.md`.
...
Use the [frontend milestone doc](../../../../docs/copeland-markdown-frontend-m12a.md) and the [phase closeout note](../../../../docs/machina-oblivion-phase-closeout-m11g.md) as the source material.
