...
function __cope_table_row_view(rowToken, table, index) {
    const row = Object.create(null);
    Object.defineProperties(row, {
        [rowToken]: { value: rowToken, writable: false, enumerable: false, configurable: false },
        [__cope_m3_table_row_table_34]: { value: table, writable: false, enumerable: false, configurable: false },
        [__cope_m3_table_row_index_35]: { value: index, writable: false, enumerable: false, configurable: false },
    });
    return Object.freeze(row);
}
function __cope_table_trusted_read(index, rowCount, resultToken, storage, rowToken, table) {
    if (!Number.isFinite(index) || !Number.isInteger(index)) {
        return __cope_m3_make_2(resultToken, "err", [{ $type: __cope_m3_type_9, $tag: "InvalidIndex", $p0: index }]);
    }
    if (index < 0 || index >= rowCount) {
        return __cope_m3_make_2(resultToken, "err", [{ $type: __cope_m3_type_9, $tag: "OutOfBounds", $p0: index, $p1: rowCount }]);
    }
    const value = storage === null ? __cope_table_row_view(rowToken, table, index) : storage[index];
    return __cope_m3_make_2(resultToken, "ok", [value]);
}
function __cope_table_trusted_column(columnToken, values, rowCount, resultToken) {
    ...
    Object.defineProperties(column, {
        ...
        [columnToken]: { value: columnToken, writable: false, enumerable: false, configurable: false },
        [__cope_m3_column_read_32]: { value: (index) => __cope_table_trusted_read(index, rowCount, resultToken, storage, null, null), writable: false, enumerable: false, configurable: false },
    });
...
function __cope_m3_table_row_create_t1_41(tableValue, index) { return __cope_table_row_view(__cope_m3_table_row_type_t1_37, tableValue, index); }

function __cope_m3_table_create_t1_40() {
    const __cope_m3_table_storage___cope_00740031002e00630030_46 = ["north", "south", "east", "west"];
    const __cope_m3_table_column_value___cope_00740031002e00630030_47 = __cope_table_trusted_column(__cope_m3_column_type___cope_00740031002e00630030_45, __cope_m3_table_storage___cope_00740031002e00630030_46, 4, __cope_m3_result_type_15);
    const __cope_m3_table_storage___cope_00740031002e00630031_50 = [1, 2, 3, 4];
    const __cope_m3_table_column_value___cope_00740031002e00630031_51 = __cope_table_trusted_column(__cope_m3_column_type___cope_00740031002e00630031_49, __cope_m3_table_storage___cope_00740031002e00630031_50, 4, __cope_m3_result_type_17);
    const __cope_m3_table_storage___cope_00740031002e00630032_54 = [__cope_m3_record_make_r1_5(1, 2), __cope_m3_record_make_r1_5(3, 4), __cope_m3_record_make_r1_5(5, 6), __cope_m3_record_make_r1_5(7, 8)];
    const __cope_m3_table_column_value___cope_00740031002e00630032_55 = __cope_table_trusted_column(__cope_m3_column_type___cope_00740031002e00630032_53, __cope_m3_table_storage___cope_00740031002e00630032_54, 4, __cope_m3_result_type_19);
    const __cope_m3_table_storage___cope_00740031002e00630033_58 = [{ $type: __cope_m3_type_12, $tag: "Present", $p0: 10 }, { $type: __cope_m3_type_12, $tag: "Present", $p0: 20 }, __cope_m3_type_12_case_0, { $type: __cope_m3_type_12, $tag: "Flagged", $p0: "sensor" }];
    const __cope_m3_table_column_value___cope_00740031002e00630033_59 = __cope_table_trusted_column(__cope_m3_column_type___cope_00740031002e00630033_57, __cope_m3_table_storage___cope_00740031002e00630033_58, 4, __cope_m3_result_type_21);
    const __cope_m3_table_storage___cope_00740031002e00630034_62 = [__cope_m3_make_2(__cope_m3_result_type_23, "ok", [10]), __cope_m3_make_2(__cope_m3_result_type_23, "ok", [20]), __cope_m3_make_2(__cope_m3_result_type_23, "err", ["missing"]), __cope_m3_make_2(__cope_m3_result_type_23, "err", ["flagged"])];
    const __cope_m3_table_column_value___cope_00740031002e00630034_63 = __cope_table_trusted_column(__cope_m3_column_type___cope_00740031002e00630034_61, __cope_m3_table_storage___cope_00740031002e00630034_62, 4, __cope_m3_result_type_25);
    ...
    Object.defineProperties(value, {
        ...
        [__cope_m3_table_rows_t1_43]: { value: (index) => {
            return __cope_table_trusted_read(index, 4, __cope_m3_result_type_27, null, __cope_m3_table_row_type_t1_37, value);
