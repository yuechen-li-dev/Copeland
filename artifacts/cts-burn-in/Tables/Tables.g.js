...
function __cope_m3_table_create_t1_40() {
    ...
    Object.defineProperties(__cope_m3_table_column_value___cope_00740031002e00630030_47, {
        ...
        [__cope_m3_column_read_32]: { value: (index) => {
            ...
            if (index < 0 || index >= 4) {
                return __cope_m3_make_2(__cope_m3_result_type_15, "err", [__cope_m3_make_2(__cope_m3_type_9, "OutOfBounds", [index, 4])]);
            }
    ...
    Object.defineProperties(__cope_m3_table_column_value___cope_00740031002e00630031_51, {
        ...
        [__cope_m3_column_read_32]: { value: (index) => {
            ...
            if (index < 0 || index >= 4) {
                return __cope_m3_make_2(__cope_m3_result_type_17, "err", [__cope_m3_make_2(__cope_m3_type_9, "OutOfBounds", [index, 4])]);
            }
    ...
    Object.defineProperties(__cope_m3_table_column_value___cope_00740031002e00630032_55, {
        ...
        [__cope_m3_column_read_32]: { value: (index) => {
            ...
            if (index < 0 || index >= 4) {
                return __cope_m3_make_2(__cope_m3_result_type_19, "err", [__cope_m3_make_2(__cope_m3_type_9, "OutOfBounds", [index, 4])]);
            }
    ...
    const __cope_m3_table_storage___cope_00740031002e00630033_58 = Object.freeze([__cope_m3_make_2(__cope_m3_type_12, "Present", [10]), __cope_m3_make_2(__cope_m3_type_12, "Present", [20]), __cope_m3_make_2(__cope_m3_type_12, "Missing", []), __cope_m3_make_2(__cope_m3_type_12, "Flagged", ["sensor"])]);
    ...
    Object.defineProperties(__cope_m3_table_column_value___cope_00740031002e00630033_59, {
        ...
        [__cope_m3_column_read_32]: { value: (index) => {
            ...
            if (index < 0 || index >= 4) {
                return __cope_m3_make_2(__cope_m3_result_type_21, "err", [__cope_m3_make_2(__cope_m3_type_9, "OutOfBounds", [index, 4])]);
            }
    ...
    Object.defineProperties(__cope_m3_table_column_value___cope_00740031002e00630034_63, {
        ...
        [__cope_m3_column_read_32]: { value: (index) => {
            ...
            if (index < 0 || index >= 4) {
                return __cope_m3_make_2(__cope_m3_result_type_25, "err", [__cope_m3_make_2(__cope_m3_type_9, "OutOfBounds", [index, 4])]);
            }
    ...
    Object.defineProperties(value, {
        ...
        [__cope_m3_table_rows_t1_43]: { value: (index) => {
            ...
            if (index < 0 || index >= 4) {
                return __cope_m3_make_2(__cope_m3_result_type_27, "err", [__cope_m3_make_2(__cope_m3_type_9, "OutOfBounds", [index, 4])]);
            }
...
function stateValue(value) {
    return (() => { const __cope_m3_match_64 = value; __cope_m3_validate_14(__cope_m3_match_64); switch (__cope_m3_match_64.$tag) { case "Missing": { return 0; } case "Present": { const reading = __cope_m3_match_64.$payload[0]; return reading; } case "Flagged": { const reason = __cope_m3_match_64.$payload[0]; return reason.length; } default: return __cope_m3_panic_0(); } })();
}
...
function rowScore(index) {
    ...
    __cope_m3_record_require_r1_6(__cope_m3_record_receiver_74);
    const __cope_m3_ordered_79 = __cope_m3_record_receiver_74[__cope_m3_record_field___cope_00720031002e00660030_7];
    ...
    __cope_m3_record_require_r1_6(__cope_m3_record_receiver_78);
    const pointScore = (__cope_m3_ordered_79 + __cope_m3_record_receiver_78[__cope_m3_record_field___cope_00720031002e00660031_8]);
...
function columnScore() {
    ...
    while ((index < 4)) {
        ...
        __cope_m3_record_require_r1_6(__cope_m3_record_receiver_102);
        (total = (__cope_m3_ordered_103 + __cope_m3_record_receiver_102[__cope_m3_record_field___cope_00720031002e00660030_7]));
        (index = (index + 1));
    }
    return total;
}
...
function boundsScore(index) {
    ...
    switch (__cope_m3_result_match_109.$tag) {
        ...
        case "err": {
            ...
            __cope_m3_result_value_110 = (() => { const __cope_m3_match_108 = error; __cope_m3_validate_11(__cope_m3_match_108); switch (__cope_m3_match_108.$tag) { case "InvalidIndex": { const value = __cope_m3_match_108.$payload[0]; return 100; } case "OutOfBounds": { const value = __cope_m3_match_108.$payload[0]; const rowCount = __cope_m3_match_108.$payload[1]; return rowCount; } default: return __cope_m3_panic_0(); } })();
            break;
        }
        default:
            __cope_m3_panic_0();
...
function repeatedAccess() {
    ...
    __cope_m3_record_require_r1_6(__cope_m3_record_receiver_130);
    const __cope_m3_ordered_135 = __cope_m3_record_receiver_130[__cope_m3_record_field___cope_00720031002e00660030_7];
    ...
    __cope_m3_record_require_r1_6(__cope_m3_record_receiver_134);
    const __cope_m3_ordered_140 = (__cope_m3_ordered_135 + __cope_m3_record_receiver_134[__cope_m3_record_field___cope_00720031002e00660030_7]);
    ...
    __cope_m3_record_require_r1_6(__cope_m3_record_receiver_139);
    const __cope_m3_ordered_145 = (__cope_m3_ordered_140 + __cope_m3_record_receiver_139[__cope_m3_record_field___cope_00720031002e00660030_7]);
    ...
    __cope_m3_record_require_r1_6(__cope_m3_record_receiver_144);
    const __cope_m3_ordered_149 = (__cope_m3_ordered_145 + __cope_m3_record_receiver_144[__cope_m3_record_field___cope_00720031002e00660030_7]);
