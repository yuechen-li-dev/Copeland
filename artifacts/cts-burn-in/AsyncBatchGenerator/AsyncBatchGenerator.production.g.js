...
function __cope_m3_record_make_r2_10(field0, field1) {
    return { [__cope_m3_record_type_r2_8]: __cope_m3_record_type_r2_8, $f0: field0, $f1: field1 };
}

function __cope_m3_record_require_r2_11(value) {
    if (typeof value !== "object" || value === null || value[__cope_m3_record_type_r2_8] !== __cope_m3_record_type_r2_8 || Object.keys(value).length !== 2 || Object.getOwnPropertySymbols(value).length !== 1 || !Object.prototype.hasOwnProperty.call(value, "$f0") || !Object.prototype.hasOwnProperty.call(value, "$f1")) {
        __cope_m3_panic_0();
    }
    if (!(typeof value.$f0 === "number")) { __cope_m3_panic_0(); }
    if (!(typeof value.$f1 === "number")) { __cope_m3_panic_0(); }
...
function __cope_m3_record_make_r3_16(field0, field1) {
    return { [__cope_m3_record_type_r3_14]: __cope_m3_record_type_r3_14, $f0: field0, $f1: field1 };
}

function __cope_m3_record_require_r3_17(value) {
    if (typeof value !== "object" || value === null || value[__cope_m3_record_type_r3_14] !== __cope_m3_record_type_r3_14 || Object.keys(value).length !== 2 || Object.getOwnPropertySymbols(value).length !== 1 || !Object.prototype.hasOwnProperty.call(value, "$f0") || !Object.prototype.hasOwnProperty.call(value, "$f1")) {
        __cope_m3_panic_0();
    }
    if (!(typeof value.$f0 === "number")) { __cope_m3_panic_0(); }
    if (!(typeof value.$f1 === "number")) { __cope_m3_panic_0(); }
...
function LoadedValue__total(value) {
    ...
    const __cope_m3_ordered_26 = __cope_m3_record_receiver_24.$f0;
    const __cope_m3_record_receiver_25 = value;
    return (__cope_m3_ordered_26 + __cope_m3_record_receiver_25.$f1);
}
    ...
    function step() {
        ...
        while (true) {
            switch (frame.__cope_state) {
                ...
                case 1: {
                    computation.resolve(__cope_m3_make_1(__cope_m3_result_type_20, "ok", [((LoadedValue__total(frame.__local_boxed) + frame.__local_local.$f0) + frame.__local_local.$f1)]));
                    return;
                }
                case 2: {
