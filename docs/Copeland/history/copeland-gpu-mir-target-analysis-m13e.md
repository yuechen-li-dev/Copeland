...
- M13g should audit `samples/Aurelian/Aurelian.VisibleTriangle` so the first visible proof target has an explicit topology and ownership boundary before `VD-MIR` implementation starts
