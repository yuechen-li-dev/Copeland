...
- Machina milestone validation remains the same focused subset used in M5h:
  - `tests/Machina.UI/Machina.Core.Tests`
  - `tests/Machina.UI/Machina.Dominatus.Tests`
  - `tests/Machina.UI/Machina.Standard.Tests`
  - `tests/Machina.UI/Machina.Pipeline.Tests`
  - `tests/Machina.UI/Machina.Presenter.Sample.Tests`
...
- `dotnet test tests/Machina.UI/Machina.Standard.Tests/Machina.Standard.Tests.csproj` passed.
- `dotnet test tests/Machina.UI/Machina.Pipeline.Tests/Machina.Pipeline.Tests.csproj` passed.
- `dotnet test tests/Machina.UI/Machina.Presenter.Sample.Tests/Machina.Presenter.Sample.Tests.csproj` passed.
- `dotnet build samples/Machina.UI/Machina.Presenter.Sample/Machina.Presenter.Sample.csproj` passed.
- `dotnet test Copeland.slnx` passed.
- `dotnet build Copeland.slnx --no-restore` passed.
- `git diff --check` passed.
- `rg -n "Avalonia|Window|Presenter" src/Machina.UI/Machina.Layout src/Machina.UI/Machina.Core src/Machina.UI/Machina.Standard src/Machina.UI/Machina.Runtime src/Machina.UI/Machina.Dominatus src/Machina.UI/Machina.Renderer.Raster src/Machina.UI/Machina.Renderer.Raster.Text src/Machina.UI/Machina.Renderer.Raster.Dominatus src/Machina.UI/Machina.Pipeline` returned no matches.
