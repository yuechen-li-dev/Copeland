...
**Status:** historical accepted design. CTS-M6b implements the frontend, binding, Cope MIR, C# proof backend, fixtures, and focused tests described here; CTS-M6c implements JavaScript private-flow lowering and Node evidence; CTS-M6d ratifies the final contract.
