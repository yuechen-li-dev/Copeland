...
| Call and argument binding | [`BinderImpl.BindExpression`](../../../src/Copeland/Copeland.TS/Semantics/Binder.cs), `BindCall`, and `BindGenericCall` | M2b adds an ordinary inferred-call path while complete explicit calls retain the M1b path and closed-instantiation factory. |
...
| Diagnostics and bounds | [`GenericDiagnosticInventoryTests`](../../../tests/Copeland/Copeland.TS.Tests/GenericDiagnosticInventoryTests.cs), and constants in [`BinderImpl`](../../../src/Copeland/Copeland.TS/Semantics/Binder.cs) | M2b uses a bounded inference diagnostic inventory with nonempty spans. |
...
CTS-TYPE-M2b implements this design's bounded direct-argument subset. See [the M2b architecture note](../architecture/copeland-ts-bounded-generic-inference-cts-type-m2b.md) and [migration ledger](../../migrations/cts-type-m2b-direct-argument-inference.md).
