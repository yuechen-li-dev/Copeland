...
Implemented by ARRAY-M0b as specified in [the design's bounded recommendation](../Copeland/language/copeland-ts-tson-arrays-design-cts-tson-array-m0a.md#exact-cts-tson-array-m0b-recommendation): semantic value/schema, reader/printer, fixtures, nominal-root nested asset lowering, and the minimum ordinary JavaScript array realization for asset parity. The separately bounded [ARRAY-M1 runtime encoder closeout](../Copeland/architecture/copeland-ts-runtime-tson-array-encoding-cts-tson-array-m1.md) subsequently added canonical runtime encoding evidence without broadening this audit's scope. JSON, tables, decoding, Results-as-data, aliases/interfaces, and root arrays remain excluded.
