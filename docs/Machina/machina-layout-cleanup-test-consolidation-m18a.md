...
M18a is a focused cleanup, bugfix, and test consolidation milestone. It fixes the known Oblivion inspector title clipping risk and consolidates high-value duplicated helpers in `tests/Machina.Presenter.Sample.Tests`.
