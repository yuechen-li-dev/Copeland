...
M8d adds exporter, importer, validator, roundtrip, deterministic output, multipage, and preflight integration tests under `tests/Machina.UI/Machina.Fonts.Tests/Artifacts`.
...
Real PNG pages remain deferred until the outline and generator proofs land in later milestones. See `docs/Machina.UI/history/machina-font-msdf-dependency-audit-m8e.md`.
...
- the new generation seam lives under `src/Machina.UI/Machina.Fonts/Generation/`
