...
That keeps this audit's swappable-boundary recommendation intact. See `docs/Machina.UI/history/machina-font-generation-adapters-m8f.md`.
...
This keeps the audit's seam-first recommendation intact while proving the intended managed dependency pair in isolation. See `docs/Machina.UI/history/machina-msdf-sharp-generator-m8h.md`.
