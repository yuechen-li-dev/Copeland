...
- the bridge contract lives in `src/Machina.UI/Machina.Fonts/ReferenceRendering`
...
M9i now proves this path in `samples/Machina.UI/Machina.Presenter.Sample`.
...
- canonical commands and artifact locations are documented in `docs/Machina.UI/history/machina-font-phase-closeout-m9i.md`
