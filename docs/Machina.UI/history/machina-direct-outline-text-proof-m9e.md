...
- the proof lives in `samples/Machina.UI/Machina.ComponentGallery.Sample`
...
The canonical integration target is `samples/Machina.UI/Machina.ComponentGallery.Sample`.
