...
It now adds an opt-in component-gallery proof card that blits CPU MSDF proof text into the exported gallery PNG while leaving normal bitmap gallery text unchanged. See `docs/Machina.UI/history/machina-component-gallery-msdf-proof-m8m.md`.
