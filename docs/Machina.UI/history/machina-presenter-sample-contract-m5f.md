...
`/samples/Machina.UI/Machina.Presenter.Sample` is the canonical Machina reference app for authoring, state, dispatch, and theme handoff.
...
Dedicated project: `tests/Machina.UI/Machina.Presenter.Sample.Tests`.
