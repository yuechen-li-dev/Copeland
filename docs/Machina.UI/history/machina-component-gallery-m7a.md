...
- M7b formalizes export contract, script, and artifact policy in `docs/Machina.UI/history/machina-component-gallery-export-m7b.md`
- M7c uses the gallery as a visual ruler in `docs/Machina.UI/history/machina-component-gallery-visual-defect-sweep-m7c.md`
- M7d fixes Badge locally in `docs/Machina.UI/history/machina-badge-intrinsic-layout-m7d.md`
- M7e records the stable baseline and limitation register in `docs/Machina.UI/history/machina-component-gallery-known-limitations-m7e.md`
...
- `samples/Machina.UI/Machina.ComponentGallery.Sample/Program.cs`
- `samples/Machina.UI/Machina.ComponentGallery.Sample/GalleryActions.cs`
- `samples/Machina.UI/Machina.ComponentGallery.Sample/GalleryState.cs`
- `samples/Machina.UI/Machina.ComponentGallery.Sample/GalleryScreen.cs`
- `samples/Machina.UI/Machina.ComponentGallery.Sample/GallerySections.cs`
- `samples/Machina.UI/Machina.ComponentGallery.Sample/GalleryTheme.cs`

Test project:

- `tests/Machina.UI/Machina.ComponentGallery.Sample.Tests/Machina.ComponentGallery.Sample.Tests.csproj`
- `tests/Machina.UI/Machina.ComponentGallery.Sample.Tests/GalleryScreenTests.cs`
- `tests/Machina.UI/Machina.ComponentGallery.Sample.Tests/GalleryGeometryTests.cs`
- `tests/Machina.UI/Machina.ComponentGallery.Sample.Tests/GalleryRenderTests.cs`
...
M7a wrote `.ppm` directly. M7b replaces that ad hoc export note with the stable `.png` contract documented in `docs/Machina.UI/history/machina-component-gallery-export-m7b.md`.
