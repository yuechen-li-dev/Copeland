...
Before M11b, `tests/Machina.UI/Machina.Fonts.Tooling.Tests` mixed:
...
That made `Machina.UI.Slow.slnx` directionally correct but too coarse. Ordinary development lost access to fast tooling coverage, while expensive export work was repeated more than necessary.
...
- font unit tests
- `tests/Machina.UI/Machina.Fonts.Tooling.Unit.Tests`
...
- `tests/Machina.UI/Machina.Fonts.Tooling.Tests`
...
dotnet test tests/Machina.UI/Machina.ComponentGallery.Sample.Tests/Machina.ComponentGallery.Sample.Tests.csproj
dotnet test tests/Machina.UI/Machina.Fonts.Tests/Machina.Fonts.Tests.csproj
dotnet test tests/Machina.UI/Machina.Fonts.Tooling.Unit.Tests/Machina.Fonts.Tooling.Unit.Tests.csproj
dotnet test tests/Machina.UI/Machina.Fonts.Tooling.Tests/Machina.Fonts.Tooling.Tests.csproj
```
...
- added `tests/Machina.UI/Machina.Fonts.Tooling.Unit.Tests`
- moved fast tooling tests back into `Machina.UI.slnx`
- kept slow export/MSDF/smoke tests in `Machina.UI.Slow.slnx`
