...
- `src/Machina.UI/Machina.Standard/Components/Badge.cs`
...
- `tests/Machina.UI/Machina.Standard.Tests/StandardComponentSnapshotTests.cs`
- `tests/Machina.UI/Machina.Standard.Tests/StandardViewFlatTests.cs`
...
- remaining roughness is documented in `docs/Machina.UI/history/machina-component-gallery-known-limitations-m7e.md`
