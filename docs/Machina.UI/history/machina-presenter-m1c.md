...
M1c expands `samples/Machina.UI/Machina.Presenter.Sample` from a counter-only interaction into a small settings panel that demonstrates multiple standard controls and immutable state transitions.
