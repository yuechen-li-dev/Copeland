...
Option E was selected for M18a. The milestone fixes the Oblivion inspector title clipping risk and consolidates duplicated test helper/setup patterns in `tests/Machina.UI/Machina.Presenter.Sample.Tests`.
