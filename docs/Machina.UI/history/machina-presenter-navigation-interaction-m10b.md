...
- Avalonia-specific translation stays in `samples/Machina.UI/Machina.Presenter.Sample/AvaloniaPresenterInputBackend.cs`.
...
M10d later adds sample-local thumb dragging with explicit pointer capture while keeping the same backend-neutral routing seam. See [docs/Machina.UI/history/machina-presenter-stabilization-m10d.md](./machina-presenter-stabilization-m10d.md).
...
M10c later makes this interacted shell the canonical/default presenter surface. See [docs/Machina.UI/history/machina-presenter-page-organization-m10c.md](./machina-presenter-page-organization-m10c.md).
