...
- the playback harness is now organized into starter and regression suites under `samples/Machina.UI/Machina.Presenter.Sample/PlaybackScenarios/`
...
Starter scenarios live under `samples/Machina.UI/Machina.Presenter.Sample/PlaybackScenarios`.
...
In M16c these now live under `samples/Machina.UI/Machina.Presenter.Sample/PlaybackScenarios/starter/`.
