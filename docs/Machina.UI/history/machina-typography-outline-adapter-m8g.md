...
- `tests/Machina.UI/Machina.Fonts.Tests/Fixtures/Fonts/SpaceMono-Regular.ttf`

License and attribution:

- `tests/Machina.UI/Machina.Fonts.Tests/Fixtures/Fonts/SpaceMono-Regular.LICENSE.txt`
- `tests/Machina.UI/Machina.Fonts.Tests/Fixtures/Fonts/README.md`
...
New public adapter types live under `src/Machina.UI/Machina.Fonts/Generation/Typography/`:
...
All of these tests live under `tests/Machina.UI/Machina.Fonts.Tests/Generation/Typography/`.
