...
These tests live in `tests/Machina.UI/Machina.Standard.Tests/Text/MachinaTextLayoutTests.cs`.
...
See `docs/Machina.UI/history/machina-standard-text-render-bridge-m6d.md` for the measurement audit and bridge contract.
