...
```text
samples/Machina.UI/Machina.Presenter.Sample/PlaybackScenarios/
  starter/
...
```powershell
.\tools\Export-MachinaPresenter.ps1 -PlaybackSuite samples/Machina.UI/Machina.Presenter.Sample/PlaybackScenarios/regressions -OutputDirectory artifacts/m16c/playback
```

Example manifest run:

```powershell
.\tools\Export-MachinaPresenter.ps1 -PlaybackSuite samples/Machina.UI/Machina.Presenter.Sample/PlaybackScenarios/m16c-oblivion-playback-suite.machina-playback-suite.toml -OutputDirectory artifacts/m16c/playback
```
