...
The active tested SDSL-V path in `src/Aurelian.Shaders/Language/*` is:
...
Actual audited source layout under `src/Aurelian.Shaders`:
...
Actual audited test layout under `tests/Aurelian.Shaders.Tests`:
...
- Tests/corpus: `tests/Aurelian.Shaders.Tests`
