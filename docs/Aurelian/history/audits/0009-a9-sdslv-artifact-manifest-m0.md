...
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderArtifact.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderArtifactEmitter.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderArtifactJsonWriter.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderArtifactManifest.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderArtifactOptions.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderArtifactStage.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderSource.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderSourceHash.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Artifacts/SdslvShaderStageKind.cs`
- `tests/Aurelian/Aurelian.Shaders.Tests/SdslvArtifactM0Tests.cs`
- `README.md`
...
`tests/Aurelian/Aurelian.Shaders.Tests/SdslvArtifactM0Tests.cs` adds coverage for:
...
- no `CodeReferences`, Stride, Machina, WyrmCoil, or Copeland coupling was introduced in `src/Aurelian/Aurelian.Shaders` or `tests/Aurelian/Aurelian.Shaders.Tests` C# files/projects;
...
rg -n "CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland" src/Aurelian/Aurelian.Shaders tests/Aurelian/Aurelian.Shaders.Tests -g '*.cs' -g '*.csproj' || true
rg -n "DXC|dxc|SPIR|spirv|Vulkan|D3D|GraphicsDevice|Window" src/Aurelian/Aurelian.Shaders/Language/Artifacts tests/Aurelian/Aurelian.Shaders.Tests -g '*.cs' || true
test -f tests/Aurelian/Aurelian.Shaders.Tests/Fixtures/Sdslv/smoke_triangle.sdslv
git status --short
```
