...
- Added `src/Aurelian/Aurelian.Graphics/Vulkan/Sync/` timeline fence types:
...
- Added `src/Aurelian/Aurelian.Graphics/Vulkan/Resources/` managed pool types:
...
- Added tests:
  - `tests/Aurelian/Aurelian.Graphics.Tests/VulkanTimelineFenceM0Tests.cs`
  - `tests/Aurelian/Aurelian.Graphics.Tests/FenceTaggedResourcePoolM0Tests.cs`
- Updated docs:
  - `README.md`
...
Boundary grep was run against `src/Aurelian/Aurelian.Graphics` and `tests/Aurelian/Aurelian.Graphics.Tests` for forbidden surface/swapchain/window/resource/command-buffer/VMA/Vortice/vendor/service-locator patterns.
...
dotnet format src/Aurelian/Aurelian.Graphics/Aurelian.Graphics.csproj --verify-no-changes --no-restore && dotnet format tests/Aurelian/Aurelian.Graphics.Tests/Aurelian.Graphics.Tests.csproj --verify-no-changes --no-restore
...
rg -n "LastCompletedFence|WaitForFenceCPUInternal|queueFamilyIndex\s*=\s*0|QueueFamilyIndex\s*=\s*0" src/Aurelian/Aurelian.Graphics -g '*.cs' || true
