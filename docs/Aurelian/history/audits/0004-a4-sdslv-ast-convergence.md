...
- Added new Aurelian SDSL-V AST contract files under `src/Aurelian/Aurelian.Shaders/Language/Ast/`.
- Added AST contract tests in `tests/Aurelian/Aurelian.Shaders.Tests/SdslvAstContractTests.cs`.
...
```text
src/Aurelian/Aurelian.Shaders/Language/Ast/
```
...
`tests/Aurelian/Aurelian.Shaders.Tests/SdslvAstContractTests.cs` covers:
...
rg -n "Mixin|EffectBlock|BaseShader|BaseCall|Compose|StageStream" src/Aurelian/Aurelian.Shaders/Language/Ast tests/Aurelian/Aurelian.Shaders.Tests -g '*.cs' || true
