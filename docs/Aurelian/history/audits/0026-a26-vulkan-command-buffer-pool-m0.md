...
- Added `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/` command-buffer lifecycle types:
...
- Added tests:
  - `tests/Aurelian/Aurelian.Graphics.Tests/VulkanCommandBufferPoolM0Tests.cs`
- Updated docs:
  - `README.md`
...
Added `tests/Aurelian/Aurelian.Graphics.Tests/VulkanCommandBufferPoolM0Tests.cs` with coverage for:
...
Boundary checks were run for forbidden concepts across `src/Aurelian/Aurelian.Graphics` and `tests/Aurelian/Aurelian.Graphics.Tests`:
