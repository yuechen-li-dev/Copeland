...
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanCompiledGraphicsPipelineDescriptorFactory.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanCompiledGraphicsPipelineDescriptorResult.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanCompiledGraphicsPipelineCreateResult.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanCompiledGraphicsPipelineDiagnostic.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanCompiledGraphicsPipelineDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanCompiledGraphicsPipelineStatus.cs`

Test file:

- `tests/Aurelian/Aurelian.Graphics.Tests/VulkanCompiledGraphicsPipelineDescriptorM0Tests.cs`
...
Added `tests/Aurelian/Aurelian.Graphics.Tests/VulkanCompiledGraphicsPipelineDescriptorM0Tests.cs` covering:
...
rg -n "Aurelian.Graphics|Silk|Vulkan|Vk|CreateShaderModule|GraphicsPipeline" src/Aurelian/Aurelian.Shaders tests/Aurelian/Aurelian.Shaders.Tests -g '*.cs' -g '*.csproj' || true
rg -n "Aurelian.Shaders|Aurelian.Graphics|Silk|Vulkan|DXC|Dxc|Microsoft.Direct3D.DXC" src/Aurelian/Aurelian.Rendering.Contracts tests/Aurelian/Aurelian.Rendering.Contracts.Tests -g '*.cs' -g '*.csproj' || true
...
rg -n "ProjectReference" src/Aurelian/Aurelian.Shaders src/Aurelian/Aurelian.Graphics src/Aurelian/Aurelian.Rendering.Contracts tests/Aurelian/Aurelian.Shaders.Tests tests/Aurelian/Aurelian.Graphics.Tests tests/Aurelian/Aurelian.Rendering.Contracts.Tests -g '*.csproj'
git status --short
```
