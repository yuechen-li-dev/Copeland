...
- `src/Aurelian/Aurelian.Shaders/Language/Validation/SdslvValidator.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Validation/SdslvValidationResult.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Validation/SdslvValidationOptions.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Validation/SdslvBuiltinTypes.cs`
- `tests/Aurelian/Aurelian.Shaders.Tests/SdslvValidationM0Tests.cs`
...
A7 adds `tests/Aurelian/Aurelian.Shaders.Tests/SdslvValidationM0Tests.cs` with ordinary xUnit tests for:
...
```bash
rg -n "sdslvtest|octest|Oct interpreter|CpuInterpreter|Evaluator" src/Aurelian/Aurelian.Shaders tests/Aurelian/Aurelian.Shaders.Tests -g '*.cs' || true
