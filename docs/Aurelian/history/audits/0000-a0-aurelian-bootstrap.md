...
- `src/Aurelian/Aurelian.*`
- `tests/Aurelian/Aurelian.*`
...
```text
tests/Aurelian/Aurelian.Core.Tests/
tests/Aurelian/Aurelian.Actuation.Tests/
tests/Aurelian/Aurelian.World.Tests/
tests/Aurelian/Aurelian.Runtime.Tests/
tests/Aurelian/Aurelian.Rendering.Contracts.Tests/
```
