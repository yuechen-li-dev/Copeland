...
- `src/Aurelian/Aurelian.Rendering.Null/Aurelian.Rendering.Null.csproj`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderStatus.cs`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderDiagnostic.cs`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderTrace.cs`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderPassTrace.cs`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderDrawTrace.cs`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderResult.cs`
- `src/Aurelian/Aurelian.Rendering.Null/NullRenderer.cs`

Test project added:

- `tests/Aurelian/Aurelian.Rendering.Null.Tests/Aurelian.Rendering.Null.Tests.csproj`
- `tests/Aurelian/Aurelian.Rendering.Null.Tests/NullRendererM0Tests.cs`
...
rg -n "Aurelian.World|UnitId|WorldData|WorldDocument|ResolvedWorld|Aurelian.Assets|Aurelian.Shaders|GraphicsDevice|Silk|Vortice|Vulkan|D3D|Window|SwapChain|RenderTarget2D|Reflection|Activator|GetType\(|Type\." src/Aurelian/Aurelian.Rendering.Null tests/Aurelian/Aurelian.Rendering.Null.Tests -g '*.cs' -g '*.csproj' || true
rg -n "CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland" src/Aurelian/Aurelian.Rendering.Null tests/Aurelian/Aurelian.Rendering.Null.Tests -g '*.cs' -g '*.csproj' || true
rg -n "ProjectReference" src/Aurelian/Aurelian.Rendering.Null tests/Aurelian/Aurelian.Rendering.Null.Tests -g '*.csproj'
```
