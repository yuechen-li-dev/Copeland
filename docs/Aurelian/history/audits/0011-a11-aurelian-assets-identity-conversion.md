...
- Renamed `src/StriV.AssetPipeline/` to `src/Aurelian/Aurelian.Assets/`.
- Renamed `src/StriV.AssetPipeline/StriV.AssetPipeline.csproj` to `src/Aurelian/Aurelian.Assets/Aurelian.Assets.csproj`.
- Renamed `src/StriV.AssetTool/` to `src/Aurelian/Aurelian.AssetTool/`.
- Renamed `src/StriV.AssetTool/StriV.AssetTool.csproj` to `src/Aurelian/Aurelian.AssetTool/Aurelian.AssetTool.csproj`.
- Updated production namespaces and imports under `src/Aurelian/Aurelian.Assets/` and `src/Aurelian/Aurelian.AssetTool/` from Stri-V identities to Aurelian identities.
- Added `tests/Aurelian/Aurelian.Assets.Tests/` smoke tests.
- Added `tests/Aurelian/Aurelian.AssetTool.Tests/` smoke tests.
...
The required inspection found no pre-existing `src/Aurelian/Aurelian.Assets` directory to merge. The repository contained the two unlinked carried-over projects:
...
Because `src/Aurelian/Aurelian.Assets` did not already exist, A11 used a direct rename strategy:

```text
src/StriV.AssetPipeline -> src/Aurelian/Aurelian.Assets
src/StriV.AssetTool -> src/Aurelian/Aurelian.AssetTool
```
...
`src/Aurelian/Aurelian.Assets/Aurelian.Assets.csproj` now declares:
...
`src/Aurelian/Aurelian.AssetTool/Aurelian.AssetTool.csproj` now declares:
...
```text
tests/Aurelian/Aurelian.Assets.Tests/
tests/Aurelian/Aurelian.AssetTool.Tests/
```
