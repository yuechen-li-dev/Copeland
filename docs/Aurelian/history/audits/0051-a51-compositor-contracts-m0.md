...
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorPolicyKind.cs`: policy-kind enum for passthrough, full-quality, reduced-frequency, and differential composition policy choices.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/PlantOutputRef.cs`: symbolic plant output reference.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/PresentationTargetRef.cs`: symbolic presentation target reference.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/PlantOutputReadinessStatus.cs`: readiness status enum.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/PlantOutputReadiness.cs`: readiness fact DTO.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/RequiredPlantOutputSet.cs`: required-output DTO plus pure satisfaction helper.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorDiagnostics.cs`: neutral compositor diagnostics DTO.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorFrameFacts.cs`: runtime-observable compositor frame facts DTO.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorDispatchRequest.cs`: neutral compositor mechanism dispatch request DTO.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorDispatchStatus.cs`: dispatch result status enum.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorDispatchDiagnostic.cs`: dispatch diagnostic severity enum and diagnostic record.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorDispatchDiagnosticCodes.cs`: M0 compositor diagnostic code constants.
- `src/Aurelian/Aurelian.Rendering.Contracts/Compositor/CompositorDispatchResult.cs`: neutral dispatch result DTO and success helper.
- `tests/Aurelian/Aurelian.Rendering.Contracts.Tests/CompositorContractsM0Tests.cs`: M0 contract tests.
...
`tests/Aurelian/Aurelian.Rendering.Contracts.Tests/CompositorContractsM0Tests.cs` covers:
...
dotnet test tests/Aurelian/Aurelian.Rendering.Contracts.Tests/Aurelian.Rendering.Contracts.Tests.csproj -c Debug
rg -n "Aurelian.Graphics|Aurelian.Runtime|Aurelian.World|Dominatus|Silk|Vulkan|Vk|Swapchain|Surface|DXC|Dxc|Microsoft.Direct3D.DXC|Aurelian.Shaders|CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland|ServiceLocator|Singleton|Activator|GetType\(|Type\." src/Aurelian/Aurelian.Rendering.Contracts tests/Aurelian/Aurelian.Rendering.Contracts.Tests -g '*.cs' -g '*.csproj' || true
rg -n "Compositor" src/Aurelian/Aurelian.Graphics src/Aurelian/Aurelian.Runtime src/Aurelian/Aurelian.World src/Aurelian/Aurelian.Shaders -g '*.cs' -g '*.csproj' || true
rg -n "ProjectReference" src/Aurelian/Aurelian.Rendering.Contracts tests/Aurelian/Aurelian.Rendering.Contracts.Tests -g '*.csproj'
git status --short
```
...
- `dotnet test tests/Aurelian/Aurelian.Rendering.Contracts.Tests/Aurelian.Rendering.Contracts.Tests.csproj -c Debug`: passed, 35 tests.
