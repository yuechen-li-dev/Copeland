...
- Updated `src/Aurelian/Aurelian.Runtime/Aurelian.Runtime.csproj` so `Aurelian.Runtime` references `Dominatus.Core`.
- Added `src/Aurelian/Aurelian.Runtime/DominatusSmokeRuntime.cs`.
- Added `tests/Aurelian/Aurelian.Runtime.Tests/DominatusRuntimeSmokeTests.cs`.
