...
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanColorClearValue.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassBeginRequest.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassCommandStatus.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassCommandDiagnostic.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassCommandDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassCommandResult.cs`
...
- render pass/framebuffer/command buffer/texture code under `src/Aurelian/Aurelian.Graphics/Vulkan`
...
Added `tests/Aurelian/Aurelian.Graphics.Tests/VulkanRenderPassCommandM0Tests.cs` covering:
...
rg -n "vkCmdBeginRenderPass|CmdBeginRenderPass|vkCmdEndRenderPass|CmdEndRenderPass" src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses tests/Aurelian/Aurelian.Graphics.Tests -g '*.cs' || true
git status --short
```
...
- `dotnet test tests/Aurelian/Aurelian.Graphics.Tests/Aurelian.Graphics.Tests.csproj -c Debug` passed with 140 passing tests.
