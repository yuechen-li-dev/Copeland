...
- `src/Aurelian/Aurelian.World/Aurelian.World.csproj`
- `src/Aurelian/Aurelian.Actuation/Aurelian.Actuation.csproj`
- `src/Aurelian/Aurelian.Core/Engine/AurelianEngine.cs`
- `src/Aurelian/Aurelian.Core/Engine/AurelianEngineOptions.cs`
- `src/Aurelian/Aurelian.Core/Engine/AurelianEngineStatus.cs`
- `src/Aurelian/Aurelian.Core/Engine/AurelianEngineDiagnostic.cs`
- `src/Aurelian/Aurelian.Core/Engine/AurelianEngineDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Core/Engine/AurelianEngineResult.cs`
- `src/Aurelian/Aurelian.Core/Compositor/ICompositorMechanism.cs`
- `src/Aurelian/Aurelian.Core/Compositor/CompositorMechanismResult.cs`
- `src/Aurelian/Aurelian.Core/Compositor/CompositorActuationBridge.cs`
- `tests/Aurelian/Aurelian.Core.Tests/AurelianEngineM0Tests.cs`
- `tests/Aurelian/Aurelian.Core.Tests/CompositorActuationBridgeM0Tests.cs`
- `README.md`
...
`tests/Aurelian/Aurelian.Core.Tests/AurelianEngineM0Tests.cs` covers default engine identity, start/stop transitions, duplicate start diagnostics, and stop-before-start diagnostics.

`tests/Aurelian/Aurelian.Core.Tests/CompositorActuationBridgeM0Tests.cs` covers neutral request forwarding, result propagation, failed result propagation, and the absence of Graphics/Vulkan requirements in Core/Core tests.
