...
- `src/Aurelian/Aurelian.Rendering.Contracts/**`
...
- `tests/Aurelian/Aurelian.Runtime.Tests/**`
...
A49 presentation lives under `src/Aurelian/Aurelian.Graphics/Vulkan/Presentation`. The current shape is typed and backend-owned:
...
find src/Aurelian/Aurelian.Rendering.Contracts -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Presentation -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Commanding -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Resources -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines -type f | sort
sed -n '1,520p' src/Aurelian/Aurelian.Rendering.Contracts/Snapshots/RenderSnapshot.cs
sed -n '1,520p' src/Aurelian/Aurelian.Rendering.Contracts/CommandPlans/RenderCommandPlan.cs
sed -n '1,520p' src/Aurelian/Aurelian.Rendering.Contracts/Shaders/CompiledShaderProgram.cs
sed -n '1,900p' src/Aurelian/Aurelian.Graphics/Vulkan/Presentation/AurelianVulkanSwapchain.cs
sed -n '1,900p' src/Aurelian/Aurelian.Graphics/Vulkan/Presentation/AurelianVulkanSurface.cs
sed -n '1,900p' src/Aurelian/Aurelian.Graphics/Vulkan/Presentation/VulkanSwapchainFactory.cs
sed -n '1,760p' src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit/VulkanCommandSubmitter.cs
sed -n '1,760p' src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Barriers/VulkanBarrierCommandEmitter.cs
find src/Aurelian/Aurelian.Runtime -type f | sort
find tests/Aurelian/Aurelian.Runtime.Tests -type f | sort
find vendor/Dominatus/src -maxdepth 5 -type f | sort
find vendor/Dominatus/samples -maxdepth 5 -type f | sort | head -n 300
sed -n '1,520p' src/Aurelian/Aurelian.Runtime/DominatusSmokeRuntime.cs 2>/dev/null || true
sed -n '1,520p' src/Aurelian/Aurelian.Runtime/AurelianRuntimeProject.cs 2>/dev/null || true
find src/Aurelian/Aurelian.Runtime -type f -name '*.cs' -print -exec sed -n '1,260p' {} \;
rg -n "AiWorld|ActuatorHost|Actuator|Act|Immediate|WaitTicks|Hfsm|HfsmGraph|Blackboard|Board|Utility|Score|State|Transition|Agent|Policy|Dispatch|Command|Result|TinyTown|Fishtank|RTSBenchmark" vendor/Dominatus/src vendor/Dominatus/samples src/Aurelian/Aurelian.Runtime tests/Aurelian/Aurelian.Runtime.Tests -g '*.cs' > /tmp/a50-dominatus-patterns.txt || true
...
- neutral compositor DTOs in `src/Aurelian/Aurelian.Rendering.Contracts/Compositor`;
