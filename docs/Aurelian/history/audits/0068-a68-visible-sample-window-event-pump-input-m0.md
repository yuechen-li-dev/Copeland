...
- `src/Aurelian/Aurelian.Graphics/Vulkan/Presentation/AurelianVulkanSurface.cs`
- `samples/Aurelian/Aurelian.VisibleTriangle/VisibleTriangleWindowState.cs`
- `samples/Aurelian/Aurelian.VisibleTriangle/VisibleTriangleFrameInputProvider.cs`
- `samples/Aurelian/Aurelian.VisibleTriangle/VisibleTriangleSamplePresentationMechanism.cs`
- `samples/Aurelian/Aurelian.VisibleTriangle/VisibleTriangleSampleFrame.cs`
- `samples/Aurelian/Aurelian.VisibleTriangle/Program.cs`
- `samples/Aurelian/Aurelian.VisibleTriangle/README.md`
- `README.md`
...
- `rg -n "PumpEvents|CloseRequested|IsCloseRequested|ShouldClose|frame-delay|Delay|Thread.Sleep|IWindow|Window.Create" samples/Aurelian/Aurelian.VisibleTriangle src/Aurelian/Aurelian.Graphics/Vulkan/Presentation -g '*.cs' || true`
- `rg -n "Thread.Sleep" src/Aurelian/Aurelian.Core src/Aurelian/Aurelian.Runtime src/Aurelian/Aurelian.Graphics -g '*.cs' || true`
- `git status --short`
