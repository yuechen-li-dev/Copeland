...
- `src/Aurelian/Aurelian.Shaders/Language/Tokens/SdslvTokenKind.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Lexing/SdslvLexer.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Ast/SdslvExpression.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Parsing/SdslvParser.cs`
- `tests/Aurelian/Aurelian.Shaders.Tests/SdslvParserM1ExpressionTests.cs`
- `tests/Aurelian/Aurelian.Shaders.Tests/SdslvParserM1StatementTests.cs`
...
A6 does not rewrite or delete the carried-over legacy shader parser, lowerer, emitter, or artifact path. The new work remains under `src/Aurelian/Aurelian.Shaders/Language` and tests under `tests/Aurelian/Aurelian.Shaders.Tests`.
...
rg -n "Mixin|EffectBlock|BaseShader|BaseCall|Compose|StageStream" src/Aurelian/Aurelian.Shaders/Language tests/Aurelian/Aurelian.Shaders.Tests docs/architecture/sdslv-compatibility-matrix.md -g '*.cs' -g '*.md' || true
