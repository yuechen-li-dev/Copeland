...
- `src/Aurelian/Aurelian.World/Stores/UnitName.cs`
- `src/Aurelian/Aurelian.World/Stores/UnitNameStore.cs`
- `src/Aurelian/Aurelian.World/Stores/Transform2.cs`
- `src/Aurelian/Aurelian.World/Stores/Transform2Store.cs`
- `src/Aurelian/Aurelian.World/Stores/WorldDataDocument.cs`
- `src/Aurelian/Aurelian.World/Stores/WorldDataSnapshot.cs`
...
- `src/Aurelian/Aurelian.Actuation/World/Requests/SetUnitNameRequest.cs`
- `src/Aurelian/Aurelian.Actuation/World/Requests/RemoveUnitNameRequest.cs`
- `src/Aurelian/Aurelian.Actuation/World/Requests/SetUnitTransform2Request.cs`
- `src/Aurelian/Aurelian.Actuation/World/Requests/RemoveUnitTransform2Request.cs`
...
- `src/Aurelian/Aurelian.Actuation/World/WorldActuationResult.cs`

Tests added:

- `tests/Aurelian/Aurelian.World.Tests/WorldTypedStoresM0Tests.cs`
- `tests/Aurelian/Aurelian.Actuation.Tests/WorldDataActuatorM0Tests.cs`
...
```bash
rg -n "EntityManager|Processor|SystemBase|ServiceLocator|Blackboard|BbKey|AiWorld|Dominatus|GraphicsDevice|Render|Shader|Asset|Reflection|Activator|GetType\(|Type\.|IComponent|ComponentStore" src/Aurelian/Aurelian.World src/Aurelian/Aurelian.Actuation tests/Aurelian/Aurelian.World.Tests tests/Aurelian/Aurelian.Actuation.Tests -g '*.cs' || true

rg -n "CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland" src/Aurelian/Aurelian.World src/Aurelian/Aurelian.Actuation tests/Aurelian/Aurelian.World.Tests tests/Aurelian/Aurelian.Actuation.Tests -g '*.cs' -g '*.csproj' || true
...
```text
tests/Aurelian/Aurelian.World.Tests/WorldUnitM0Tests.cs:165:    public void WorldDocument_DoesNotRequireRendererAssetsOrDominatus()
```
