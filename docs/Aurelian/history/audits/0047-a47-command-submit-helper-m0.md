...
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit/VulkanCommandSubmitRequest.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit/VulkanCommandSubmitResult.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit/VulkanCommandSubmitStatus.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit/VulkanCommandSubmitDiagnostic.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit/VulkanCommandSubmitDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit/VulkanCommandSubmitter.cs`
- `tests/Aurelian/Aurelian.Graphics.Tests/VulkanCommandSubmitterM0Tests.cs`
- `tests/Aurelian/Aurelian.Graphics.Tests/VulkanOffscreenDrawRecordingM0Tests.cs`
- `README.md`
...
`tests/Aurelian/Aurelian.Graphics.Tests/VulkanCommandSubmitterM0Tests.cs` covers:
...
rg -n "vkQueueSubmit|QueueSubmit|Submit" src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Submit src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Uploads tests/Aurelian/Aurelian.Graphics.Tests -g '*.cs' || true
git status --short
```
