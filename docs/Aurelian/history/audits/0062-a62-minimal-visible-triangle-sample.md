...
* Added `samples/Aurelian/Aurelian.VisibleTriangle/Aurelian.VisibleTriangle.csproj` for the standalone sample executable.
* Added sample-local setup, presentation, top-level program, static SPIR-V fixture, and README files under `samples/Aurelian/Aurelian.VisibleTriangle/`.
...
The sample lives at `samples/Aurelian/Aurelian.VisibleTriangle/` with namespace `Aurelian.VisibleTriangle`. It references:
