...
- `samples/Aurelian/Aurelian.VisibleTriangle/VisibleTriangleFrameState.cs`
...
- `rg -n "AurelianFrameLoop|AurelianRuntimeSession|AurelianRuntimeTickFrameStep|AurelianRuntimeSessionTickerAdapter|MaxFrames|AcquireNextImage|PresentAsync" samples/Aurelian/Aurelian.VisibleTriangle -g '*.cs' || true`
