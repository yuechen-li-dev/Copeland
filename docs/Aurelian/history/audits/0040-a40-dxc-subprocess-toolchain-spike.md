...
- Added DXC executable resolution, diagnostics, status/result records, and SPIR-V subprocess compile wrapper under `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/`.
- Added tiny HLSL vertex and pixel fixtures under `tests/Aurelian/Aurelian.Shaders.Tests/Fixtures/Hlsl/`.
