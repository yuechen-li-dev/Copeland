...
- `src/Aurelian/Aurelian.World/Stores/Renderable2DData.cs`
- `src/Aurelian/Aurelian.World/Stores/Renderable2DStore.cs`
- `src/Aurelian/Aurelian.World/Stores/WorldDataDocument.cs`
- `src/Aurelian/Aurelian.World/Stores/WorldDataSnapshotBuilder.cs`
- `src/Aurelian/Aurelian.World/Stores/UnitDataSnapshot.cs`
- `src/Aurelian/Aurelian.Actuation/World/Requests/SetRenderable2DRequest.cs`
- `src/Aurelian/Aurelian.Actuation/World/Requests/RemoveRenderable2DRequest.cs`
- `src/Aurelian/Aurelian.Actuation/World/WorldActuationDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Actuation/World/WorldDataActuator.cs`
- `src/Aurelian/Aurelian.Runtime/Aurelian.Runtime.csproj`
- `src/Aurelian/Aurelian.Runtime/Rendering/WorldRenderSnapshotOptions.cs`
- `src/Aurelian/Aurelian.Runtime/Rendering/WorldRenderSnapshotDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Runtime/Rendering/WorldRenderSnapshotExtractor.cs`

Test files changed or added:

- `tests/Aurelian/Aurelian.World.Tests/Renderable2DStoreM0Tests.cs`
- `tests/Aurelian/Aurelian.Actuation.Tests/Renderable2DActuatorM0Tests.cs`
- `tests/Aurelian/Aurelian.Runtime.Tests/Aurelian.Runtime.Tests.csproj`
- `tests/Aurelian/Aurelian.Runtime.Tests/WorldRenderSnapshotExtractorM0Tests.cs`
...
```bash
rg -n "ProjectReference" src/Aurelian/Aurelian.Runtime tests/Aurelian/Aurelian.Runtime.Tests -g '*.csproj'
rg -n "Aurelian.Rendering|RenderSnapshot|RenderItem|RenderMeshRef|RenderMaterialRef" src/Aurelian/Aurelian.World tests/Aurelian/Aurelian.World.Tests -g '*.cs' -g '*.csproj' || true
rg -n "Aurelian.Rendering.Null|NullRenderer" src/Aurelian/Aurelian.Runtime -g '*.cs' -g '*.csproj' || true
rg -n "Aurelian.Assets|Aurelian.Shaders|GraphicsDevice|Silk|Vortice|Vulkan|D3D|Window|SwapChain|RenderTarget2D|Reflection|Activator|GetType\(|Type\." src/Aurelian/Aurelian.World src/Aurelian/Aurelian.Runtime src/Aurelian/Aurelian.Actuation tests/Aurelian/Aurelian.World.Tests tests/Aurelian/Aurelian.Actuation.Tests tests/Aurelian/Aurelian.Runtime.Tests -g '*.cs' -g '*.csproj' || true
rg -n "CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland" src/Aurelian/Aurelian.World src/Aurelian/Aurelian.Runtime src/Aurelian/Aurelian.Actuation tests/Aurelian/Aurelian.World.Tests tests/Aurelian/Aurelian.Actuation.Tests tests/Aurelian/Aurelian.Runtime.Tests -g '*.cs' -g '*.csproj' || true
```
