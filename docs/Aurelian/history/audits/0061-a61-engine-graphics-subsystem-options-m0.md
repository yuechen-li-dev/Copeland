...
- `src/Aurelian/Aurelian.Core/Engine/AurelianEngineOptions.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianEngineGraphicsMode.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianEngineGraphicsOwnership.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianEngineGraphicsOptions.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/IPresentationMechanism.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianPreparedGraphicsSubsystem.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianPreparedGraphicsSubsystemValidation.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianPreparedGraphicsSubsystemResult.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianPreparedGraphicsSubsystemStatus.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianPreparedGraphicsSubsystemDiagnostic.cs`
- `src/Aurelian/Aurelian.Core/Engine/Graphics/AurelianPreparedGraphicsSubsystemDiagnosticCodes.cs`
- `tests/Aurelian/Aurelian.Core.Tests/AurelianEngineGraphicsOptionsM0Tests.cs`
- `README.md`
...
`tests/Aurelian/Aurelian.Core.Tests/AurelianEngineGraphicsOptionsM0Tests.cs` covers:
...
dotnet test tests/Aurelian/Aurelian.Core.Tests/Aurelian.Core.Tests.csproj -c Debug
dotnet test tests/Aurelian/Aurelian.Integration.Tests/Aurelian.Integration.Tests.csproj -c Debug
rg -n "CreateVulkanSurface|Window.Create|Vk.GetApi|vkCreate|vkCmd|vkQueue|Swapchain|Surface|Silk|Vulkan|Vk" src/Aurelian/Aurelian.Core/Engine/Graphics src/Aurelian/Aurelian.Core/Engine/Frames tests/Aurelian/Aurelian.Core.Tests -g '*.cs' || true
rg -n "Aurelian.Runtime|Dominatus|AiWorld|ActuatorHost|Hfsm|Blackboard|CompositorDispatchAct|CompositorPolicySession" src/Aurelian/Aurelian.Graphics -g '*.cs' -g '*.csproj' || true
rg -n "Aurelian.Graphics|Silk|Vulkan|Vk|Swapchain|Surface" src/Aurelian/Aurelian.Runtime -g '*.cs' -g '*.csproj' || true
rg -n "Aurelian.Runtime|Aurelian.Graphics|Silk|Vulkan|Dominatus" src/Aurelian/Aurelian.Rendering.Contracts -g '*.cs' -g '*.csproj' || true
