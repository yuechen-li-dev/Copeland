...
- Added new SDSL-V token contracts under `src/Aurelian/Aurelian.Shaders/Language/Tokens/`.
- Added new SDSL-V lexer and lex result under `src/Aurelian/Aurelian.Shaders/Language/Lexing/`.
- Added new SDSL-V diagnostics contracts under `src/Aurelian/Aurelian.Shaders/Language/Diagnostics/`.
- Added parser M0 and parse result under `src/Aurelian/Aurelian.Shaders/Language/Parsing/`.
- Added lexer/parser tests under `tests/Aurelian/Aurelian.Shaders.Tests/`.
...
The carried-over legacy files under `src/Aurelian/Aurelian.Shaders/Ast/`, `src/Aurelian/Aurelian.Shaders/Lexing/`, `src/Aurelian/Aurelian.Shaders/Parsing/`, `src/Aurelian/Aurelian.Shaders/Lowering/`, and `src/Aurelian/Aurelian.Shaders/Artifacts/` were not modified. Artifact emission remains on the legacy path.
...
rg -n "namespace Aurelian\.Shaders\.Language" src/Aurelian/Aurelian.Shaders/Language -g '*.cs'
git status --short
```
