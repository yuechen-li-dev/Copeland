...
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcArtifactValidationResult.cs`
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcCommandLineBuilder.cs`
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcDiscovery.cs`
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcExecutable.cs`
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcValidationRequest.cs`
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcValidationResult.cs`
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcValidationStatus.cs`
- `src/Aurelian/Aurelian.Shaders/Language/External/Dxc/DxcValidator.cs`
- `tests/Aurelian/Aurelian.Shaders.Tests/DxcValidationM0Tests.cs`
- `README.md`
...
`tests/Aurelian/Aurelian.Shaders.Tests/DxcValidationM0Tests.cs` adds deterministic coverage for:
...
rg -n "Vulkan|GraphicsDevice|Window|SwapChain|RenderTarget" src/Aurelian/Aurelian.Shaders/Language/External/Dxc tests/Aurelian/Aurelian.Shaders.Tests -g '*.cs' || true
git status --short
```
