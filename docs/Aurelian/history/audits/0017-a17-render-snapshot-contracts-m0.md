...
Production contracts added under `src/Aurelian/Aurelian.Rendering.Contracts/Snapshots/`:
...
Tests added under `tests/Aurelian/Aurelian.Rendering.Contracts.Tests/`:
...
rg -n "CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland" src/Aurelian/Aurelian.Rendering.Contracts tests/Aurelian/Aurelian.Rendering.Contracts.Tests -g '*.cs' -g '*.csproj' || true

rg -n "ProjectReference" src/Aurelian/Aurelian.Rendering.Contracts src/Aurelian/Aurelian.World src/Aurelian/Aurelian.Actuation -g '*.csproj'
