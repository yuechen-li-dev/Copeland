...
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/VulkanCommandBufferLease.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassScope.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassBeginResult.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassCommandDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassCommandEncoder.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw/VulkanViewportScissor.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw/VulkanDrawVerticesRequest.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw/VulkanDrawCommandStatus.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw/VulkanDrawCommandDiagnostic.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw/VulkanDrawCommandDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw/VulkanDrawCommandResult.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw/VulkanDrawCommandEncoder.cs`
- `tests/Aurelian/Aurelian.Graphics.Tests/VulkanRenderPassCommandM0Tests.cs`
- `tests/Aurelian/Aurelian.Graphics.Tests/VulkanDrawCommandM0Tests.cs`
- `README.md`
...
Added `tests/Aurelian/Aurelian.Graphics.Tests/VulkanDrawCommandM0Tests.cs` covering:
...
```bash
git status --short
find src/Aurelian/Aurelian.Graphics -type f | sort
find tests/Aurelian/Aurelian.Graphics.Tests -type f | sort
...
find src/Aurelian/Aurelian.Graphics/Vulkan/Commanding -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Buffers -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Allocation -type f | sort
sed -n '1,760p' src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/VulkanCommandBufferLease.cs
sed -n '1,760p' src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/RenderPasses/VulkanRenderPassCommandEncoder.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/AurelianVulkanGraphicsPipeline.cs
sed -n '1,760p' src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanGraphicsPipelineFactory.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Buffers/AurelianVulkanBuffer.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Buffers/VulkanBufferUsage.cs
...
dotnet build src/Aurelian/Aurelian.Graphics/Aurelian.Graphics.csproj -c Debug
dotnet test tests/Aurelian/Aurelian.Graphics.Tests/Aurelian.Graphics.Tests.csproj -c Debug
dotnet build Aurelian.slnx -c Debug
dotnet test Aurelian.slnx -c Debug
dotnet test tests/Aurelian/Aurelian.Graphics.Tests/Aurelian.Graphics.Tests.csproj -c Debug
rg -n "Aurelian.Shaders|Dxc|DXC|Microsoft.Direct3D.DXC|SDSL|Sdslv|Hlsl|SpirvShaderArtifact" src/Aurelian/Aurelian.Graphics tests/Aurelian/Aurelian.Graphics.Tests -g '*.cs' -g '*.csproj' || true
rg -n "Vortice|VMASharp|Vma|SwapChain|Swapchain|Surface|CreateVulkanSurface|IWindow|Window.Create|Aurelian.World|Aurelian.Rendering.Null|Dominatus|CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland|ServiceLocator|Singleton|Activator|GetType\(|Type\." src/Aurelian/Aurelian.Graphics tests/Aurelian/Aurelian.Graphics.Tests -g '*.cs' -g '*.csproj' || true
rg -n "vkCmdBindPipeline|CmdBindPipeline|vkCmdBindVertexBuffers|CmdBindVertexBuffers|vkCmdSetViewport|CmdSetViewport|vkCmdSetScissor|CmdSetScissor|vkCmdDraw|CmdDraw" src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/Draw tests/Aurelian/Aurelian.Graphics.Tests -g '*.cs' || true
git status --short
```
...
- `dotnet build src/Aurelian/Aurelian.Graphics/Aurelian.Graphics.csproj -c Debug` passed.
- `dotnet test tests/Aurelian/Aurelian.Graphics.Tests/Aurelian.Graphics.Tests.csproj -c Debug` passed: 178 tests.
