...
| --- | --- | --- |
| A22 | `Aurelian.Graphics` project scaffold and Silk.NET package references | Create `src/Aurelian/Aurelian.Graphics` and `tests/Aurelian/Aurelian.Graphics.Tests`; add Silk.NET Vulkan/windowing packages; folder structure and package smoke only; no Vulkan implementation. |
...
- create `src/Aurelian/Aurelian.Graphics`;
- create `tests/Aurelian/Aurelian.Graphics.Tests`;
