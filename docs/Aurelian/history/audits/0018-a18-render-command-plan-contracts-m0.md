...
Production contracts added under `src/Aurelian/Aurelian.Rendering.Contracts/CommandPlans/`:
...
rg -n "ProjectReference" src/Aurelian/Aurelian.Rendering.Contracts -g '*.csproj'
