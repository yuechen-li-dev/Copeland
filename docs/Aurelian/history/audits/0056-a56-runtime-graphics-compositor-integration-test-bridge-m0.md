...
- Added `tests/Aurelian/Aurelian.Integration.Tests/Aurelian.Integration.Tests.csproj` and added it to `Aurelian.slnx`.
- Added integration compositor tests under `tests/Aurelian/Aurelian.Integration.Tests/Compositor/RuntimeGraphicsCompositorBridgeM0Tests.cs`.
- Added test-only support helpers under `tests/Aurelian/Aurelian.Integration.Tests/Support/`.
...
The new `tests/Aurelian/Aurelian.Integration.Tests` project references:
