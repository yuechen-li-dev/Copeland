...
- Added neutral compiled shader contract DTOs under `src/Aurelian/Aurelian.Rendering.Contracts/Shaders`.
- Added compiled shader artifact exporter types under `src/Aurelian/Aurelian.Shaders/Language/Artifacts/Compiled`.
- Added a project reference from `Aurelian.Shaders` to `Aurelian.Rendering.Contracts`.
- Added compiled shader to Vulkan stage mapping types under `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics`.
...
- `dotnet test tests/Aurelian/Aurelian.Rendering.Contracts.Tests/Aurelian.Rendering.Contracts.Tests.csproj -c Debug` passed with 21 tests.
- `dotnet test tests/Aurelian/Aurelian.Shaders.Tests/Aurelian.Shaders.Tests.csproj -c Debug` passed with 97 tests.
- `dotnet test tests/Aurelian/Aurelian.Graphics.Tests/Aurelian.Graphics.Tests.csproj -c Debug` passed with 157 tests.
