...
| --- | --- |
| `src/Aurelian/Aurelian.Core/Aurelian.Core.csproj` | Core Aurelian project. |
| `src/Aurelian/Aurelian.Actuation/Aurelian.Actuation.csproj` | Actuation-facing runtime module. |
| `src/Aurelian/Aurelian.Rendering.Contracts/Aurelian.Rendering.Contracts.csproj` | Rendering contracts, no shader compiler implementation yet. |
| `src/Aurelian/Aurelian.Runtime/Aurelian.Runtime.csproj` | Runtime smoke harness; already references vendored Dominatus from A1. |
| `src/Aurelian/Aurelian.World/Aurelian.World.csproj` | World/runtime support module. |
...
| --------------------------- | -------------------- | ------ | ------ |
| `src/StriV.ShaderPipeline/StriV.ShaderPipeline.csproj` | `src/Aurelian/Aurelian.Shaders/Aurelian.Shaders.csproj` | Rename/move directly, then edit metadata | This is the module seed, but project identity must become Aurelian. |
...
| `src/StriV.AssetPipeline/` | future `src/Aurelian/Aurelian.Assets/` | Defer | Out of A2 scope. |
...
- Rename `src/StriV.ShaderPipeline` to `src/Aurelian/Aurelian.Shaders`.
...
> **A3: create `src/Aurelian/Aurelian.Shaders` from `src/StriV.ShaderPipeline`, update namespaces/project metadata, optionally link with minimal tests, and keep behavior unchanged.**
