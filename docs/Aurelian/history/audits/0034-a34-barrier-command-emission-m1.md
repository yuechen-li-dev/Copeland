...
- Added `VulkanBarrierCommandEmitter` plus emission status/result/diagnostic-code records under `src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Barriers/`.
...
- Added `tests/Aurelian/Aurelian.Graphics.Tests/VulkanBarrierCommandEmissionM1Tests.cs` for empty-list no-ops, command-buffer recording emission, combined buffer/image emission, and wrong-plant rejection.
...
`tests/Aurelian/Aurelian.Graphics.Tests/VulkanBarrierCommandEmissionM1Tests.cs` adds:
