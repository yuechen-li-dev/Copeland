...
- `tests/Aurelian/Aurelian.Graphics.Tests/Fixtures/Spirv/TriangleSpirvFixtures.cs`
...
Boundary searches were also run for forbidden dependency and presentation terms under `src/Aurelian/Aurelian.Graphics` and `tests/Aurelian/Aurelian.Graphics.Tests`.
