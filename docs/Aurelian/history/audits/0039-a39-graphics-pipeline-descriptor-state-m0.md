...
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanShaderStageKind.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanShaderStageDescriptor.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanVertexAttributeFormat.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanVertexAttributeDescriptor.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanVertexBufferLayoutDescriptor.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanGraphicsPipelineDescriptor.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanGraphicsPipelineStatus.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanGraphicsPipelineDiagnostic.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanGraphicsPipelineDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanGraphicsPipelineCreateResult.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/AurelianVulkanGraphicsPipeline.cs`
- `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics/VulkanGraphicsPipelineFactory.cs`
- `tests/Aurelian/Aurelian.Graphics.Tests/VulkanGraphicsPipelineM0Tests.cs`
- `README.md`
...
- render pass, framebuffer, command buffer, and plant code under `src/Aurelian/Aurelian.Graphics/Vulkan`
...
Added `tests/Aurelian/Aurelian.Graphics.Tests/VulkanGraphicsPipelineM0Tests.cs` covering:
...
- `dotnet test tests/Aurelian/Aurelian.Graphics.Tests/Aurelian.Graphics.Tests.csproj -c Debug` passed with 151 tests.
...
- The native-call isolation scan showed the new shader module, pipeline layout, graphics pipeline, and destroy calls isolated to `src/Aurelian/Aurelian.Graphics/Vulkan/Pipelines/Graphics`.
