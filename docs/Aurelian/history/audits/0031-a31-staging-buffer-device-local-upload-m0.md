...
- Added `src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Uploads/` with upload request, result, status, diagnostics, diagnostic codes, and the M0 one-shot `VulkanBufferUploader`.
- Added `tests/Aurelian/Aurelian.Graphics.Tests/VulkanBufferUploadM0Tests.cs`.
...
find src/Aurelian/Aurelian.Graphics/Vulkan/Sync -type f | sort
find src/Aurelian/Aurelian.Graphics/Vulkan/Device -type f | sort
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Buffers/AurelianVulkanBuffer.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Buffers/VulkanBufferFactory.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Allocation/IVulkanMemoryAllocator.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/VulkanCommandBufferPool.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Commanding/VulkanCommandBufferLease.cs
sed -n '1,520p' src/Aurelian/Aurelian.Graphics/Vulkan/Sync/VulkanFenceBundle.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Sync/VulkanTimelineFence.cs
sed -n '1,620p' src/Aurelian/Aurelian.Graphics/Vulkan/Device/AurelianVulkanPlant.cs
```
...
rg -n "vkAllocateMemory|vkFreeMemory|AllocateMemory|FreeMemory|vkMapMemory|vkUnmapMemory|MapMemory|UnmapMemory" src/Aurelian/Aurelian.Graphics -g '*.cs'
rg -n "vkCmdCopyBuffer|CmdCopyBuffer|vkQueueSubmit|QueueSubmit|Submit" src/Aurelian/Aurelian.Graphics/Vulkan/Resources/Uploads src/Aurelian/Aurelian.Graphics/Vulkan/Commanding tests/Aurelian/Aurelian.Graphics.Tests -g '*.cs' || true
git status --short
```
