...
- `tests/Aurelian/Aurelian.Integration.Tests/Compositor/CoreVisibleFramePumpIntegrationM0Tests.cs`
- `tests/Aurelian/Aurelian.Integration.Tests/Support/VulkanVisibleFrameTestFixture.cs`
- `README.md`
