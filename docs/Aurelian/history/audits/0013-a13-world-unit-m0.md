...
- `src/Aurelian/Aurelian.World/Units/UnitId.cs`
- `src/Aurelian/Aurelian.World/Units/UnitKindId.cs`
- `src/Aurelian/Aurelian.World/Units/UnitLogicRef.cs`
- `src/Aurelian/Aurelian.World/Units/UnitChild.cs`
- `src/Aurelian/Aurelian.World/Units/UnitComposition.cs`
- `src/Aurelian/Aurelian.World/Units/WorldUnitDescriptor.cs`
- `src/Aurelian/Aurelian.World/Units/WorldDocument.cs`
- `src/Aurelian/Aurelian.World/Units/ResolvedWorld.cs`
- `src/Aurelian/Aurelian.World/Units/ResolvedWorldUnit.cs`
- `src/Aurelian/Aurelian.World/Units/WorldUnitResolver.cs`
- `src/Aurelian/Aurelian.World/Units/WorldResolutionResult.cs`
- `src/Aurelian/Aurelian.World/Units/WorldResolutionDiagnostic.cs`
- `src/Aurelian/Aurelian.World/Units/WorldResolutionDiagnosticSeverity.cs`
- `src/Aurelian/Aurelian.World/Units/WorldResolutionDiagnosticCodes.cs`
- `tests/Aurelian/Aurelian.World.Tests/WorldUnitM0Tests.cs`
- `README.md`
...
`tests/Aurelian/Aurelian.World.Tests/WorldUnitM0Tests.cs` adds coverage for:
...
rg -n "EntityManager|Processor|SystemBase|ServiceLocator|Blackboard|BbKey|AiWorld|Dominatus|GraphicsDevice|Render|Shader|Asset" src/Aurelian/Aurelian.World tests/Aurelian/Aurelian.World.Tests -g '*.cs' || true
rg -n "CodeReferences|Stride\.|Machina\.|WyrmCoil|Copeland" src/Aurelian/Aurelian.World tests/Aurelian/Aurelian.World.Tests -g '*.cs' -g '*.csproj' || true
git status --short
```
