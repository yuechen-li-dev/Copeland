...
- `src/Aurelian/Aurelian.Shaders/Language/Diagnostics/SdslvDiagnosticPhase.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Emission/Hlsl/HlslEmitter.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Emission/Hlsl/HlslEmissionDiagnosticCodes.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Emission/Hlsl/HlslEmissionOptions.cs`
- `src/Aurelian/Aurelian.Shaders/Language/Emission/Hlsl/HlslEmissionResult.cs`
- `tests/Aurelian/Aurelian.Shaders.Tests/Fixtures/Sdslv/smoke_triangle.sdslv`
- `tests/Aurelian/Aurelian.Shaders.Tests/HlslEmissionM0Tests.cs`
- `README.md`
...
`tests/Aurelian/Aurelian.Shaders.Tests/HlslEmissionM0Tests.cs` adds coverage for:
...
The fixture is read from `tests/Aurelian/Aurelian.Shaders.Tests/Fixtures/Sdslv/smoke_triangle.sdslv` and is not generated inside test code.
...
rg -n "Mixin|EffectBlock|BaseShader|BaseCall|Compose|StageStream" src/Aurelian/Aurelian.Shaders/Language tests/Aurelian/Aurelian.Shaders.Tests -g '*.cs' || true
git status --short
```
