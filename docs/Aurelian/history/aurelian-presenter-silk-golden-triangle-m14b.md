...
The runnable entry point remains `samples/Aurelian/Aurelian.VisibleTriangle`.
...
- `src/Aurelian/Aurelian.Core/Graphics/Vulkan/Presentation/VulkanPresentationMechanism.cs`
...
```powershell
dotnet run --project samples/Aurelian/Aurelian.VisibleTriangle/Aurelian.VisibleTriangle.csproj -- --presenter silk --frames 120
```
