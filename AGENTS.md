...
All TypeScript and C# should be formatted as ordinary readable source: multi-line functions, clear variable names, explicit branches where helpful, and small helpers for repeated logic. Avoid clever one-liners, nested ternaries, and dense chained expressions.
