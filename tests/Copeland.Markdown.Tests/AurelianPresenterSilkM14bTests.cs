...
public sealed class AurelianPresenterSilkM14bTests
{
    ...
    public void M14bDocs_Exist()
    {
        ...
        Assert.True(File.Exists(Path.Combine(root, "docs", "Aurelian", "aurelian-presenter-silk-golden-triangle-m14b.md")));
        Assert.True(File.Exists(Path.Combine(root, "samples", "Aurelian.VisibleTriangle", "README.md")));
    }
