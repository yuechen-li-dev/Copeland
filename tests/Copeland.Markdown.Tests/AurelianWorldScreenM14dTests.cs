...
public sealed class AurelianWorldScreenM14dTests
{
    ...
    public void M14dDocs_Exist()
    {
        ...
        Assert.True(File.Exists(Path.Combine(root, "docs", "Aurelian", "aurelian-world-screen-m14d.md")));
    ...
    {
        string doc = File.ReadAllText(Path.Combine(GetRepositoryRoot(), "docs", "Aurelian", "aurelian-world-screen-m14d.md"));
