...
public sealed class MachinaUiStackAuthoringM17bTests
{
    ...
    {
        Assert.True(File.Exists(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-ui-stack-authoring-m17b.md")));
    ...
    {
        string doc = File.ReadAllText(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-ui-stack-authoring-m17b.md"));
        string backlog = File.ReadAllText(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-layout-authoring-backlog-m17a.md"));
