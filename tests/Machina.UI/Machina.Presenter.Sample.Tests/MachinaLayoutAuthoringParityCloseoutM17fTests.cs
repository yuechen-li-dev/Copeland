...
public sealed class MachinaLayoutAuthoringParityCloseoutM17fTests
{
    ...
    {
        Assert.True(File.Exists(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-layout-authoring-parity-closeout-m17f.md")));
        Assert.True(File.Exists(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-layout-parity-next-steps-m17f.md")));
    ...
    {
        string closeoutDoc = File.ReadAllText(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-layout-authoring-parity-closeout-m17f.md"));
        string nextStepsDoc = File.ReadAllText(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-layout-parity-next-steps-m17f.md"));
