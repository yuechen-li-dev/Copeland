...
public sealed class OblivionDocsDogfoodM12dTests
{
    ...
    public void DocsDogfood_PreservesSourcePaths()
    {
        ...
        Assert.Equal("docs/Machina.UI/history/machina-oblivion-phase-closeout-m11g.md", card.SourcePath);
    ...
    public void DocsDogfood_AurelianDocsPreserveSourcePaths()
    {
        ...
        Assert.Equal("docs/Aurelian/history/aurelian-monorepo-import-audit-m13a.md", card.SourcePath);
        Assert.Equal(card.SourcePath, card.Body.BodySourcePath);
    }
    ...
    public void DocsDogfood_InspectorShowsSourcePath()
    {
        ...
        Assert.Equal("docs/Machina.UI/history/machina-oblivion-phase-closeout-m11g.md", card.SourcePath);
        Assert.Equal("docs/Machina.UI/history/machina-oblivion-phase-closeout-m11g.md", card.Body.BodySourcePath);
    }
    ...
    public void DocsDogfoodManifest_RecordsDocsAndDiagnostics()
    {
        ...
        try
        {
            ...
            Assert.Contains("\"sourcePath\": \"docs/Machina.UI/history/machina-oblivion-phase-closeout-m11g.md\"", json, StringComparison.Ordinal);
    ...
    public void M13c_DoesNotMoveSdslvToCopeland()
    {
        string combinedText = string.Join(
            Environment.NewLine,
            GetSourceFiles("src", "Copeland", "Copeland.Markdown")
                .Concat(GetSourceFiles("src", "Copeland", "Copeland.Cli"))
    ...
    public void M13c_DoesNotImplementMachinaAurelianBridge()
    {
        string combinedText = string.Join(
            Environment.NewLine,
            GetSourceFiles("src", "Machina.UI", "Machina.Core")
                .Concat(GetSourceFiles("src", "Machina.UI", "Machina.Standard"))
                .Concat(GetSourceFiles("src", "Machina.UI", "Machina.Layout"))
                .Concat(GetSourceFiles("src", "Machina.UI", "Machina.Runtime"))
                .Concat(GetSourceFiles("src", "Machina.UI", "Machina.Pipeline"))
                .Select(File.ReadAllText));
    ...
    {
        return Path.Combine(GetRepositoryRoot(), "samples", "Machina.UI", "Machina.Presenter.Sample", "OblivionSampleWorkspace", "workspace.oblivion.json");
    }
