...
public sealed class PresenterAdaptiveShellM12hTests
{
    ...
    {
        string cardRendererSource = File.ReadAllText(Path.Combine(RepoRoot, "samples", "Machina.UI", "Machina.Presenter.Sample", "OblivionCardRenderer.cs"));
    ...
    {
        string stateSource = File.ReadAllText(Path.Combine(RepoRoot, "samples", "Machina.UI", "Machina.Presenter.Sample", "PresenterNavigationCatalog.cs"));
        string cardSource = File.ReadAllText(Path.Combine(RepoRoot, "samples", "Machina.UI", "Machina.Presenter.Sample", "OblivionCardRenderer.cs"));
    ...
    private static string ReadSampleSource()
    {
        return string.Join(
            Environment.NewLine,
            Directory.GetFiles(Path.Combine(RepoRoot, "samples", "Machina.UI", "Machina.Presenter.Sample"), "*.cs", SearchOption.TopDirectoryOnly)
