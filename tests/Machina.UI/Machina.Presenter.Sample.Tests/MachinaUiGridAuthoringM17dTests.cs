...
public sealed class MachinaUiGridAuthoringM17dTests
{
    ...
    {
        Assert.True(File.Exists(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-ui-grid-authoring-m17d.md")));
    ...
    {
        string doc = File.ReadAllText(Path.Combine(RepoRoot, "docs", "Machina.UI", "history", "machina-ui-grid-authoring-m17d.md"));
