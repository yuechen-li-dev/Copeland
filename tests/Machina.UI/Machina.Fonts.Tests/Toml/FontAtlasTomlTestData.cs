...
internal static class FontAtlasTomlTestData
{
    public static FontAtlasTomlDocument CreateDocument()
    {
        return new FontAtlasTomlDocument
        {
            ...
            Glyphs = [new FontAtlasGlyphToml { Codepoint = 65, Char = "A", EmSize = 32, Weight = 400, Slant = "upright", Page = 0, X = 12, Y = 16, Width = 40, Height = 44, Advance = 36, BearingX = 1, BearingY = 34, U0 = 12.0 / 1024.0, V0 = 16.0 / 1024.0, U1 = 52.0 / 1024.0, V1 = 60.0 / 1024.0, PlaneLeft = 1, PlaneTop = -34, PlaneRight = 41, PlaneBottom = 10, PixelRange = 4, ProjectionScale = 1 }],
        };
    }
}
