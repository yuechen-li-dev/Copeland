...
public sealed class MachinaJsParityLayoutReconM17aTests
{
    ...
    {
        Assert.True(File.Exists(Path.Combine(RepoRoot, "docs", "Machina", "machina-js-parity-layout-recon-m17a.md")));
        Assert.True(File.Exists(Path.Combine(RepoRoot, "docs", "Machina", "machina-layout-authoring-backlog-m17a.md")));
    ...
    {
        string reconDoc = File.ReadAllText(Path.Combine(RepoRoot, "docs", "Machina", "machina-js-parity-layout-recon-m17a.md"));
        string backlogDoc = File.ReadAllText(Path.Combine(RepoRoot, "docs", "Machina", "machina-layout-authoring-backlog-m17a.md"));
