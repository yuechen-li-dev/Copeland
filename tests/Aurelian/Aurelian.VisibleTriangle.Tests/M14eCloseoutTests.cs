...
public sealed class M14eCloseoutTests
{
    ...
    public void M14eCloseoutDocs_Exist()
    {
        ...
        Assert.True(File.Exists(Path.Combine(repoRoot, "docs", "Aurelian", "history", "aurelian-migration-closeout-m14e.md")));
    ...
    public void M14e_DoesNotAddAurelianToCopelandSolutions()
    {
        ...
        var copelandSlowSolution = File.ReadAllText(Path.Combine(repoRoot, "Machina.UI.Slow.slnx"));
