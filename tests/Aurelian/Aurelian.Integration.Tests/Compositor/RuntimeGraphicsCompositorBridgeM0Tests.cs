...
public sealed class RuntimeGraphicsCompositorBridgeM0Tests
{
    ...
    public void RuntimeGraphicsCompositorBridge_ProductionProjectsRemainDecoupled()
    {
        ...
        string runtimeProject = File.ReadAllText(Path.Combine(repoRoot, "src/Aurelian/Aurelian.Runtime/Aurelian.Runtime.csproj"));
        string graphicsProject = File.ReadAllText(Path.Combine(repoRoot, "src/Aurelian/Aurelian.Graphics/Aurelian.Graphics.csproj"));
        string contractsProject = File.ReadAllText(Path.Combine(repoRoot, "src/Aurelian/Aurelian.Rendering.Contracts/Aurelian.Rendering.Contracts.csproj"));
